...
//second I need to create references to the table tax bracket cells
const tableFirstBracket = document.getElementById('table-first-bracket');
const tableSecondBracket = document.getElementById('table-second-bracket');
const tableThirdBracket = document.getElementById('table-third-bracket');
const tableFourthBracket = document.getElementById('table-fourth-bracket');
const tableFifthBracket = document.getElementById('table-fifth-bracket');
const tableSixthBracket = document.getElementById('table-sixth-bracket');
